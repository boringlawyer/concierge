...
var SignupWindow = function SignupWindow(props) {
  return /*#__PURE__*/React.createElement("form", {
    ...
    className: "formSubmit btn btn-primary",
    type: "submit",
    value: props.isAdmin ? "Sign up as admin" : "Sign up"
  }));
};
...
var setup = function setup(csrf) {
  ...
  var adminSignupButton = document.querySelector('[href="/adminSignup"]'); // hooks up the three buttons to change the form
